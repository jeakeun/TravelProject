...
const translations = {
  KR: {
    ...
    menu_board_title: "여행게시판", 
    board_rec: "여행 추천게시판", 
    board_review: "여행 후기 게시판", 
    board_free: "자유게시판", 
    board_map: "여행지도", // 🚩 board_qna를 board_map으로 변경
  ...
  EN: {
    ...
    menu_board_title: "Travel Board", 
    board_rec: "Recommendation", 
    board_review: "Review", 
    board_free: "Free Board", 
    board_map: "Travel Map", // 🚩 변경
  ...
  JP: {
    nav_news: "ニュース", nav_board: "掲示판", nav_cs: "サポート", nav_mypage: "マイページ", nav_admin: "管理者",
    user_login: "ログイン", user_signup: "会員登録",
    menu_news_title: "ニュース", news_notice: "お知らせ", news_event: "イベント", news_letter: "ニュースレター",
    menu_board_title: "旅行掲示板", 
    board_rec: "おすすめ掲示板", 
    board_review: "レビュー掲示板", 
    board_free: "自由掲示板", 
    board_map: "旅行地図", // 🚩 변경
      ...
      <header>
        ...
        <nav>
          <ul className="nav-list">
            ...
            {/* 🚩 여행게시판 클릭 시 추천게시판으로 기본 이동하도록 설정 */}
